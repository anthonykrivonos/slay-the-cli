...
// builders / legality helpers in src/ui/runlogic.ts drive a scripted run
// through neow -> map -> combat -> rewards -> map with the real engine.
// (Rendering lives in main.ts/panels.ts and needs a browser; everything the
// screens DECIDE with is exercised here.)
...
describe("pure helpers", () => {
  test("seed handling", () => {
    ...
    expect(seedFromSearch("?foo=1&seed=Run2")).toBe("RUN2");
